...
var config = {
    ...
    // certificate chain.
    publicHostname: '<TENANT_NAME>.adept-dev-private.synergissoftware.com',
    usingSSLproxy: true,
    ...
    spawnWebsocketPortsBegin: 11200,
    ...
    modelDirs: [
        "/mnt/data/drawings",
        "/mnt/data/streamcaches",
		"/mnt/data/pdfconversions"
    ],  

    //Folder contain all cache folder of Conversion
    localConverter: "/mnt/data/streamcaches", 

    //Folder contain all drawings, support Open File Page (Only for Dev)
    drawingsConverter: "/mnt/data/drawings",
